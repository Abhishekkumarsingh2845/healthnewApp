...
//   const allArticles = useGetArticles().slice(0,10);
...
//   console.log('latest realm in explore', art);
...
//     }
//   };
//   const trendingArt = useQuery('TrendingArticle');
//   console.log('->---------------trending realm in explore', trendingArt);
//   useEffect(() => {
...
//           article => article.category === activeCategory,
//         );
//   }, [trendingArticlesFromRealm, activeCategory]);
...
//     () => allArticles.filter(article => nameret.includes(article.category)),
//     [allArticles, nameret],
//   );
...
//     fetchDates(); // Initial fetch

//     const listener = () => fetchDates();
//     const datesCollection = realm.objects(Datesch);

//     datesCollection.addListener(listener);

//     return () => {
//       datesCollection.removeListener(listener);
//     };
//   }, []);
...
//       return isWithinDateRange && isCategoryMatch;
//     });
//   }, [allArticles, startDa, endDa, activeCategory, nameret]);
...
//   const fl = useMemo(() => {
//     return trendingArticlesFromRealm.filter(article => {
//       const updatedAtDate = normalizeDate(article.updatedAt);
//       const startDate = startDa ? normalizeDate(startDa) : null;
//       const endDate = endDa ? normalizeDate(endDa) : null;
//       const isWithinDateRange =
...
//   const ffv = useMemo(() => {
//     return combinedFavArticles.filter(article => {
//       const updatedAtDate = normalizeDate(article.updatedAt);
//       const startDate = startDa ? normalizeDate(startDa) : null;
//       const endDate = endDa ? normalizeDate(endDa) : null;
//       const isWithinDateRange =
...
//       return isWithinDateRange && isCategoryMatch;
//     });
//   }, [combinedFavArticles, startDa, endDa, activeCategory, nameret]);
