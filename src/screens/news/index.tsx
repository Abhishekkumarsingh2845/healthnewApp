...
const index = (props: NewsPropType) => {
  ...
  console.log("published articles in the Realm",allArticles);
  const filteredlatestArticles =
  selectedCategory === 'All' || !selectedCategory
    ? allArticles
    : allArticles.filter(allArticles => allArticles.category === selectedCategory);
  ...
  return (
    <AppSafeAreaView>
      ...
      <View style={{flex: 1}}>
        <InfiniteList
          data={filteredlatestArticles as any}
